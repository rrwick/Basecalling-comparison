...
basecaller_names <- c("Albacore v1.0.4", "Albacore v1.1.2", "Albacore v1.2.6", "Albacore v2.0.0", "Albacore v2.0.1")
basecaller_colours <- brewer.pal(5, "YlOrRd")
...
# Load the tables
albacore_v1_0_4_reads <- read_tsv("results/albacore_v1.0.4_reads.tsv", skip = 1, col_names = c("Name", "Length_1.0.4", "Identity_1.0.4", "Rel_len_1.0.4"))
...
albacore_v2_0_1_reads <- read_tsv("results/albacore_v2.0.1_reads.tsv", skip = 1, col_names = c("Name", "Length_2.0.1", "Identity_2.0.1", "Rel_len_2.0.1"))

albacore_v1_0_4_assembly <- read_tsv("results/albacore_v1.0.4_assembly.tsv", skip = 1, col_names = c("Name", "Length_1.0.4", "Identity_1.0.4", "Rel_len_1.0.4"))
...
albacore_v2_0_1_assembly <- read_tsv("results/albacore_v2.0.1_assembly.tsv", skip = 1, col_names = c("Name", "Length_2.0.1", "Identity_2.0.1", "Rel_len_2.0.1"))

albacore_v1_0_4_nanopolish <- read_tsv("results/albacore_v1.0.4_nanopolished_assembly.tsv", skip = 1, col_names = c("Name", "Length_1.0.4", "Identity_1.0.4", "Rel_len_1.0.4"))
...
albacore_v2_0_1_nanopolish <- data.frame(Name = numeric(), Length_2.0.1 = numeric(), Identity_2.0.1 = numeric(), Rel_len_2.0.1 = numeric())  # temporary empty table, until Nanopolish supports Albacore v2
...
all_nanopolish <- merge(all_nanopolish, albacore_v2_0_1_nanopolish, by=1, all=TRUE)



# Reformat data frames for ggplot
basecaller_identities <- c("Identity_1.0.4", "Identity_1.1.2", "Identity_1.2.6", "Identity_2.0.0", "Identity_2.0.1")
basecaller_rel_lengths <- c("Rel_len_1.0.4", "Rel_len_1.1.2", "Rel_len_1.2.6", "Rel_len_2.0.0", "Rel_len_2.0.1")
...
albacore_v1_0_4_aligned = 100.0 * sum(albacore_v1_0_4_reads[albacore_v1_0_4_reads$Identity_1.0.4 != 0.0,]$Length_1.0.4) / sum(albacore_v1_0_4_reads$Length_1.0.4)
albacore_v1_0_4_unaligned = 100.0 * sum(albacore_v1_0_4_reads[albacore_v1_0_4_reads$Identity_1.0.4 == 0.0,]$Length_1.0.4) / sum(albacore_v1_0_4_reads$Length_1.0.4)
...
albacore_v2_0_1_aligned = 100.0 * sum(albacore_v2_0_1_reads[albacore_v2_0_1_reads$Identity_2.0.1 != 0.0,]$Length_2.0.1) / sum(albacore_v2_0_1_reads$Length_2.0.1)
albacore_v2_0_1_unaligned = 100.0 * sum(albacore_v2_0_1_reads[albacore_v2_0_1_reads$Identity_2.0.1 == 0.0,]$Length_2.0.1) / sum(albacore_v2_0_1_reads$Length_2.0.1)

aligned_proportion <- data.frame(Basecaller = factor(), Aligned = numeric(), Unaligned = numeric())
aligned_proportion <- rbind(aligned_proportion, data.frame(Basecaller = factor("Albacore v1.0.4"), Aligned = albacore_v1_0_4_aligned, Unaligned = albacore_v1_0_4_unaligned))
