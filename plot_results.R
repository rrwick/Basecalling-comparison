...
read_identities <- all_reads[,c("Name", "Length_2.0.1", "Identity_1.1.2", "Identity_1.2.6", "Identity_2.0.0", "Identity_2.0.1")]
colnames(read_identities) <- c("Name", "Length", "Albacore v1.1.2", "Albacore v1.2.6", "Albacore v2.0.0", "Albacore v2.0.1")
read_identities <- melt(read_identities, id=c("Name", "Length"))
colnames(read_identities) <- c("Read_name", "Length", "Basecaller", "Identity")

read_rel_lengths <- all_reads[,c("Name", "Length_2.0.0", "Rel_len_1.1.2", "Rel_len_1.2.6", "Rel_len_2.0.0", "Rel_len_2.0.1")]
colnames(read_rel_lengths) <- c("Name", "Length", "Albacore v1.1.2", "Albacore v1.2.6", "Albacore v2.0.0", "Albacore v2.0.1")
...
assembly_identities <- all_assemblies[,c("Name", "Length_2.0.0", "Identity_1.1.2", "Identity_1.2.6", "Identity_2.0.0", "Identity_2.0.1")]
colnames(assembly_identities) <- c("Name", "Length", "Albacore v1.1.2", "Albacore v1.2.6", "Albacore v2.0.0", "Albacore v2.0.1")
...
nanopolish_identities <- all_nanopolish[,c("Name", "Length_1.2.6", "Identity_1.1.2", "Identity_1.2.6", "Identity_2.0.0", "Identity_2.0.1")]
colnames(nanopolish_identities) <- c("Name", "Length", "Albacore v1.1.2", "Albacore v1.2.6", "Albacore v2.0.0", "Albacore v2.0.1")
